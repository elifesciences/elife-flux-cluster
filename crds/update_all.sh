...
./ack-controllers/route53-controller/update.sh $(cat ../system/ack-system/route53-release.yaml  | yq .spec.chart.spec.version)
./ack-controllers/cloudfront-controller/update.sh $(cat ../system/ack-system/cloudfront-release.yaml  | yq .spec.chart.spec.version)
